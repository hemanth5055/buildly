  ...
  return (
    <div className="w-full flex flex-col gap-4">
      ...
      <div className="w-full flex justify-between items-center ">
        {/* name */}
        <h1 className="font-medium text-[40px]  text-black dark:text-[#F3F5F7] tracking-[-1.2px]">
          Buildly
        </h1>
        {/* logout */}
      ...
      <div className="w-full flex flex-col gap-4 items-center mt-[100px] mb-[30px]">
        ...
        <textarea
          name="prompt"
          id="prompt"
          className="w-[60%] h-[200px] rounded-[10px] bg-[#eeeeee] outline-none p-4 text-[20px] resize-none"
          placeholder="What are you planning to create?"
        ></textarea>
        {/* button-to-generate-website */}
        <div className="bg-black px-4 py-2 rounded-[5px] text-white cursor-pointer">
          Generate 🚀
        </div>
      </div>
      ...
      <div className="w-full flex flex-col gap-4 p-4">
        ...
        <div className="w-full flex hover:bg-[#ebebeb] p-4 rounded-[10px]">
          {/* project-details */}
          <div className="w-full flex flex-col gap-1">
            {/* project-name */}
            <h1 className="font-medium text-[30px] text-black dark:text-[#F3F5F7] tracking-[-1px]">
              Simple Todo App
            </h1>
            <p>
